...
<div class="login-form">  
  ...
  <i class="glyphicon glyphicon-lock"></i>
		...
		<br>
 <div class="text-center small">Don't have an account? <a href="register">Register</a></div>
</div>		
    </form>	
	
   
<div class="text-center small">By logging in,you accept <a>our terms and conditions</a></div>
